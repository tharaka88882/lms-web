...
INSERT INTO `admins` (`id`,`created_at`,`updated_at`) VALUES 
 (1,'2022-06-07 12:35:01','2022-06-07 12:35:01');
...
CREATE TABLE `experiences` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `text` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `experiences_institute_id_foreign` (`institute_id`),
  KEY `experiences_position_id_foreign` (`position_id`),
  CONSTRAINT `experiences_institute_id_foreign` FOREIGN KEY (`institute_id`) REFERENCES `institutes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `experiences_position_id_foreign` FOREIGN KEY (`position_id`) REFERENCES `positions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `experiences_teacher_id_foreign` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE
...
INSERT INTO `experiences` (`id`,`text`,`location`,`start_date`,`end_date`,`teacher_id`,`institute_id`,`position_id`,`created_at`,`updated_at`) VALUES 
 (3,'',NULL,'2022-06-06','2022-06-14',1,5,2,'2022-06-08 08:27:49','2022-06-08 08:27:49'),
 (4,'',NULL,'2022-06-13','2022-06-09',1,7,3,'2022-06-08 08:28:24','2022-06-08 08:28:24'),
 (5,'',NULL,'2022-06-05','2022-06-08',2,8,4,'2022-06-08 08:37:21','2022-06-08 08:37:21');
...
--
-- Definition of table `institutes`
--
...
INSERT INTO `institutes` (`id`,`text`,`created_at`,`updated_at`) VALUES 
 (1,'test','2022-06-07 12:35:46','2022-06-07 12:35:46'),
 (2,'rrr','2022-06-07 12:36:15','2022-06-07 12:36:15'),
 (3,'df','2022-06-07 14:18:29','2022-06-07 14:18:29'),
 (4,'ffff','2022-06-08 07:38:32','2022-06-08 07:38:32'),
 (5,'adsfjo','2022-06-08 08:27:49','2022-06-08 08:27:49'),
 (6,'fvfb','2022-06-08 08:28:06','2022-06-08 08:28:06'),
 (7,'vopsn','2022-06-08 08:28:24','2022-06-08 08:28:24'),
 (8,'dfgh','2022-06-08 08:37:21','2022-06-08 08:37:21');
...
INSERT INTO `migrations` (`id`,`migration`,`batch`) VALUES 
 ...
 (36,'2022_06_03_133433_create_stikey_milestones_table',1),
 (37,'2022_06_06_174718_create_positions_table',1),
 (38,'2022_06_06_174719_create_institutes_table',1),
 (39,'2022_06_06_174720_create_qualifications_table',1),
 (40,'2022_06_06_174902_create_experiences_table',1);
...
CREATE TABLE `milestones` (
  ...
  `stikey` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `payment_packages` (`id`,`name`,`streaming_count`,`description`,`price`,`color`,`status`,`created_at`,`updated_at`) VALUES 
 (1,'Premium',5,'Description','100.00','#ff0000',1,'2022-06-07 12:35:02','2022-06-07 12:35:02');
...
INSERT INTO `positions` (`id`,`text`,`created_at`,`updated_at`) VALUES 
 (1,'test','2022-06-07 12:35:46','2022-06-07 12:35:46'),
 (2,'fe','2022-06-08 08:27:49','2022-06-08 08:27:49'),
 (3,'gvopsvjo','2022-06-08 08:28:24','2022-06-08 08:28:24'),
 (4,'rhtr','2022-06-08 08:37:21','2022-06-08 08:37:21');
...
CREATE TABLE `qualifications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `qualifications_teacher_id_foreign` (`teacher_id`),
  KEY `qualifications_institute_id_foreign` (`institute_id`),
  CONSTRAINT `qualifications_institute_id_foreign` FOREIGN KEY (`institute_id`) REFERENCES `institutes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `qualifications_teacher_id_foreign` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE
...
INSERT INTO `qualifications` (`id`,`text`,`location`,`start_date`,`end_date`,`teacher_id`,`institute_id`,`created_at`,`updated_at`) VALUES 
 (2,'tdd',NULL,'2022-06-05',NULL,1,4,'2022-06-08 07:38:33','2022-06-08 07:38:33'),
 (3,'getfgfdv',NULL,'2022-06-16',NULL,1,6,'2022-06-08 08:28:06','2022-06-08 08:28:06');
...
INSERT INTO `sessions` (`id`,`user_id`,`ip_address`,`user_agent`,`payload`,`last_activity`) VALUES 
 ('u5FNxWruAlO5mmj8crRUriK95PYyMOZd7xuZt8V0',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.0.0 Safari/537.36','',1654681151);
...
INSERT INTO `settings` (`id`,`commission`,`payout_limit`,`streaming_amount`,`paid_level`,`created_at`,`updated_at`) VALUES 
 (1,0,'100.00','5.00',4,'2022-06-07 12:35:02','2022-06-07 12:35:02');
/*!40000 ALTER TABLE `settings` ENABLE KEYS */;


--
-- Definition of table `stikey_milestones`
--

DROP TABLE IF EXISTS `stikey_milestones`;
CREATE TABLE `stikey_milestones` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `s_note` varchar(2048) COLLATE utf8mb4_unicode_ci NOT NULL,
  `milestone_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `stikey_milestones_milestone_id_foreign` (`milestone_id`),
  KEY `stikey_milestones_user_id_foreign` (`user_id`),
  CONSTRAINT `stikey_milestones_milestone_id_foreign` FOREIGN KEY (`milestone_id`) REFERENCES `milestones` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stikey_milestones_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `stikey_milestones`
--

/*!40000 ALTER TABLE `stikey_milestones` DISABLE KEYS */;
/*!40000 ALTER TABLE `stikey_milestones` ENABLE KEYS */;
...
CREATE TABLE `stikey_note_mentees` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `note` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `student_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `students` (`id`,`grade`,`status`,`created_at`,`updated_at`) VALUES 
 (1,NULL,1,'2022-06-07 12:35:01','2022-06-07 12:35:01');
...
INSERT INTO `teachers` (`id`,`nic`,`qualification`,`experience`,`skills`,`amount`,`status`,`rating`,`level`,`created_at`,`updated_at`,`job`,`linkedin_link`,`industry`) VALUES 
 (1,NULL,NULL,NULL,NULL,'0.00',1,0,4,'2022-06-07 12:35:01','2022-06-07 12:35:01',NULL,NULL,NULL),
 (2,NULL,NULL,NULL,NULL,'0.00',1,0,4,'2022-06-07 12:35:01','2022-06-07 12:35:01',NULL,NULL,NULL);
...
CREATE TABLE `users` (
  ...
  `social_id` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `social_type` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`,`name`,`email`,`image`,`cover_image`,`address`,`city`,`country`,`email_verified_at`,`password`,`two_factor_secret`,`two_factor_recovery_codes`,`remember_token`,`current_team_id`,`profile_photo_path`,`social_id`,`social_type`,`company`,`first_login`,`created_at`,`updated_at`,`userable_type`,`userable_id`,`oauth_id`,`oauth_type`,`streaming_count`) VALUES 
 (1,'thusitha','thusitha@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,'$2y$10$Dh4RI3wAJKDfCy1HOQZ7p.hKrgFKJ.Q96PAC3aws/fnwg4rMLKING',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2022-06-07 12:35:01','2022-06-07 12:35:27','App\\Models\\Teacher','1',NULL,NULL,0),
 (2,'Kavidu','kavidu@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,'$2y$10$J1ny1KO0mw81FtAVn2YAou7DmWZt86y0V6Cphr5CKIteFhu7aNkSW',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2022-06-07 12:35:01','2022-06-08 08:28:41','App\\Models\\Teacher','2',NULL,NULL,0),
 (3,'dinesh','dinesh@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,'$2y$10$k9NBaG.3rw8mrS6X.UYcl.Wk.94gBdd9BUojISAez1KuTL1farvU2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2022-06-07 12:35:01','2022-06-08 08:39:14','App\\Models\\Student','1',NULL,NULL,0),
 (4,'gaveen','gaveen@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,'$2y$10$EtiRocJBxHaJApa6p1LHbeSuyMeLsnmOXI.TGgqwh.7n5uyYka4.i',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'2022-06-07 12:35:02','2022-06-07 12:35:02','App\\Models\\Admin','1',NULL,NULL,0);
