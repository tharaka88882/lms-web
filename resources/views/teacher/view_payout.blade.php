            ...
            <div class="invoice p-5 mb-3">
              ...
              <div class="row">
                ...
                <div class="float-right">
                 <small> <b>Reference No: #INV0000{{$userTransaction->id}}</b></small><br>
                  <br>
                  {{-- <small>  <b>Order ID: </b> 4F3S8J</small><br> --}}
                   <small>  <b>Account Name: </b>{{$userTransaction->sender->name}}</small><br>
                   <small>  <b>Payment Date: </b>{{date('Y/m/d | H:i', strtotime($userTransaction->updated_at))}}</small>
                </div>
              ...
              <div class="row no-print">
                <div class="col-12">
                    <form action="" method="post">
                        ...
                        <h5 class="text-right"><span class="badge badge-{{$userTransaction->status==('1')? 'success':'warning'}}">{{$userTransaction->status==('1')? 'Completed':'Processing'}}</span><h5>
