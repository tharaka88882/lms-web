                        ...
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-light">
                                <div class="inner">
                                    ...
                                    @else
                                        @if ($relevance <= 25)
                                            <h3 style="color: red;">{{ $relevance }}<sup style="font-size: 20px">%</sup>
                                            </h3>
                                        @elseif ($relevance > 25 && $relevance < 65)
                                            <h3 style="color: rgb(255, 174, 0);">{{ $relevance }}<sup
                                                    style="font-size: 20px">%</sup></h3>
                                        @else
                                            <h3 style="color: green;">{{ $relevance }}<sup
                                                    style="font-size: 20px">%</sup></h3>
                                        @endif
                                    @endif
                    ...
                    <div class="col-md-12">
                                    ...
                                    <div class="row pull-right">
                                        ...
                                        <div class="p-1">
                                            <div class="form-group" id="currentModal">
                                                ...
                                                <select class="select2 form-control" data-placeholder="Any"
                                                    style="width: 100%;" name="search_rating">
                                                    <option>Any</option>
                                                    <option>5</option>
                                                    <option>4</option>
                                                    <option>3</option>
                        ...
                        <div class="row">
                            @foreach ($ratings as $rating)
                                <div class="col-xs-12 col-sm-6 col-md-6 d-flex align-items-stretch flex-column">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="row">
                                                <div class="col-10">
                                                    ...
                                                    <p class="text-muted text-md"> How would you rate your overall
                                                        experience with the mentor: <b>{{ $rating->rating }}</b></p>
                                                    <p class="text-muted text-md"> Any Comments?
                                                        <b>{{ $rating->description }}</b>
                                                    </p>
                                                    <p class="text-muted text-md"> Was Your Questions answered ?:
                                                        <b>{{ $rating->answer == 1 ? 'Yes' : 'No' }}</b>
                                                    </p>
