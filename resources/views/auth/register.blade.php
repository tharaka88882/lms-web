 ...
 <div id="form_div">
    <form action="{{ route('auth.verify_mentee_email') }}" method="post">
        ...
        <div id="name_div" class="input-group mb-3">
          <input type="text" class="form-control @if($errors->has('name')) {{'is-invalid'}} @endif" placeholder="Full name" name="name">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user"></span>
            </div>
      ...
      @endif
        ...
        <div id="pass2_div" class="input-group mb-3">
          <input type="password" class="form-control @if($errors->has('password_confirmation')) {{'is-invalid'}} @endif" name="password_confirmation" placeholder="Retype password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
      ...
      @endif
        ...
        <div id="agree_div" class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button disabled id="registerBtn" type="submit" class="btn btn-primary btn-block">  {{ __('Register') }}</button>
          </div>
          <!-- /.col -->
        </div>
    </form>
