    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div id="form_div">
                    <form method="POST" action="{{ route('auth.verify_code') }}">
                        @csrf
                        <input type="hidden" name="encrited_code" value="{{ $en_code }}" />
                        <input type="hidden" name="email" value="{{ $email }}" />
                        <div class="input-group mb-3">
                            <input type="password"
                                class="form-control @if ($errors->has('veri_code')) {{ 'is-invalid' }} @endif"
                                name="veri_code" placeholder="Verification Code">
