            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-light">
                        ...
                        <a href="{{ route('admin.pending_teacher') }}" class="small-box-footer">More info <i
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-light">
                        ...
                        <a href="{{ route('admin.teachers') }}" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-light">
                        ...
                        <a href="{{ route('admin.students') }}" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-light">
                        <div class="inner">
                            ...
                            <p>Skills/Professions</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-ios-book"></i>
                        </div>
                        <a href="{{ route('admin.subjects') }}" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                                    ...
                                    <tbody>
                                        @foreach ($pending_teachers_list as $teacher)
                                            <tr>
                                                ...
                                                <td>
                                                    <h5><span
                                                            class="badge badge-secondary">{{ $teacher->status == '1' ? 'Approved' : 'Pending' }}</span>
                                                        <h5>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('admin.edit_teacher', $teacher->id) }}"><i
                                                            class="far fa-edit"></i> Approve</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
