            ...
            <div class="invoice p-5 mb-3">
              ...
              <div class="row">
                ...
                <div class="float-right">
                 <small> <b>Reference No: #{{$user_order->reference}}</b></small><br>
                  <br>
                  {{-- <small>  <b>Order ID: </b> 4F3S8J</small><br> --}}
                   <small>  <b>Account Name: </b>{{$user_order->user->name}}</small><br>
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <td>Unlimited Chat | {{$user_order->payment_package->streaming_count}} Video Streamings</td>
              ...
              <div class="row no-print">
                <div class="col-12">
                    <form action="{{ route('processTransaction') }}" method="post">
                        ...
                        <input type="hidden" name="amount" value="{{$user_order->amount}}">
                        {{-- <a href="invoice-print.html" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                        {{-- <button type="submit" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Submit
                            Payment
                        </button> --}}
                        <h5 class="text-right"><span class="badge badge-{{$user_order->status==('1')? 'success':'danger'}}">{{$user_order->status==('1')? 'Successful':'Unsuccessful'}}</span><h5>
