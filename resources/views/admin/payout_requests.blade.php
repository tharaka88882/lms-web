                ...
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{date('Y/m/d | H:i', strtotime($userTransaction->created_at))}}</td>
                            <td><h5><span class="badge badge-secondary">{{$userTransaction->status==('1')? 'Completed':'Processing'}}</span><h5></td>
                            <td>
                                <a class="btn btn-sm btn-warning" href="{{route('admin.view_payout',$userTransaction->id)}}"><i class="far fa-eye"></i> View</a>
                            </td>
                        </tr>
                        @php
                            $i++;
