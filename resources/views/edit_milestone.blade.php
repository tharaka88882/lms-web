                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Goals</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('user.milestone_update',$id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="note" value="{{$milestone->note}}" name="note" placeholder="Name" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        id="due_date" value="{{$milestone->due_date}}" name="due_date" placeholder="Milestone Due Date" required>
